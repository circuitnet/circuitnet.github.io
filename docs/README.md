...
| Version | Description |
| --- | --- |
| CircuitNet 1.0 [Paper](https://ieeexplore.ieee.org/document/10158384) [Link](https://drive.google.com/drive/folders/1GjW-1LBx1563bg3pHQGvhcEyK2A9sYUB?usp=sharing) | Physical Design in 28nm Planar CMOS. |
| CircuitNet 2.0 [Paper](https://openreview.net/forum?id=nMFSUjxMIl) [Link](https://huggingface.co/datasets/CircuitNet/CircuitNet/tree/main) | Physical Design in 14nm FinFET. |
...
> CircuitNet is a large-scale open-source dataset dedicated to machine learning (ML) applications in electronic design automation (EDA) for chip design.

![Data](/assets/overall_structure-DrBTioEF.png)


<!-- The website is powered by [VuePress](https://vuejs.press). -->
